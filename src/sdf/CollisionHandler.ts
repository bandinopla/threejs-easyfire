...
import { DataTexture, EasyFireShaderContext, VoxelGrid } from "../EasyFireShaderContext.js";
import { cross, dot, float, If, Loop, mat4, uint, uniform, uniformArray, vec3, vec4, normalize, mix } from "three/tsl";
import { sdfSampler, SDFSampler } from "./sdfSampler.js";
import { BasicShapes, SDFShape, SDFShapeContext } from "./shape/SDFShape.js";
import { SDFBox } from "./shape/SDFBox.js";
import { SDFEllipsoid } from "./shape/SDFEllipsoid.js";
...
export class CollisionHandler {
	 ...
	 */
	bakeCollidersPass(context: EasyFireShaderContext) {
		return () => {
